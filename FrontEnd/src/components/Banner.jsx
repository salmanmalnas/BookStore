  ...
  return(
    <>
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-16">
          <div className="w-full order-2 md:order-1 md:w1/2 mt-10 md:mt-12">
            ...
            <div>
              <button className="mt-6 btn text-white hover:text-black bg-orange-500"><a href="/contact">Contact</a></button>                
            </div>
          </div>
          <div className="order-1 w-full md:w1/2 md:mt-12 md:ml-5">
